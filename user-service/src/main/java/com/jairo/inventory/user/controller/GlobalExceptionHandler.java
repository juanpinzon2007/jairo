...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler({EntityExistsException.class, BadCredentialsException.class, EntityNotFoundException.class})
    ResponseEntity<ApiError> handleBusiness(RuntimeException ex, ServerWebExchange exchange) {
        HttpStatus status = ex instanceof BadCredentialsException ? HttpStatus.UNAUTHORIZED
                : ex instanceof EntityNotFoundException ? HttpStatus.NOT_FOUND : HttpStatus.CONFLICT;
